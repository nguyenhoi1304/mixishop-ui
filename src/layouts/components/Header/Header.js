                ...
                <div className={cx('inner')}>
                    ...
                    <div className={cx('header-wrapperLeft')}>
                        <Link to={config.routes.home}  >
                            <img className={cx('logo-images')} src={images.logo} alt="TikTok" />
                        </Link>
                        <div className={cx('search-link')} >
                            ...
                            <div ref={listproducst} className={cx('header-link')}>
                                <Link to={config.routes.home} style={{ cursor: 'text' }} onClick={() => setShowItem(!showitem)}>
                            ...
                            <Link to={config.routes.thongbao} className={cx('header-link')}>THÔNG BÁO</Link>
                    ...
                    <div className={cx('header-wrapperRight')}>
                        <div className={cx('phone-number')}>
                            ...
                            <Tippy
                                ...
                                content='09222222016'
                                placement='bottom'>
                                <h3 className={cx('phone')} >0922222016</h3>
                            </Tippy>
                        </div>
