                    ...
                    <div className={cx('inner')}>
                        ...
                        <div className={cx('header-wrapperLeft')}>
                            <Link to={config.routes.home}  >
                                <img onClick={() => setShow(true)} className={cx(['logo-images', offset > 750 && 'imgchange'])} src={images.logo} alt="mixi" />
                            </Link>
                        ...
                        <div className={cx('header-wrapperRight')}>
                            ...
                            {isLogin ? <img src={avatar} alt='avatar' className={cx('avatar_login')} ></img> :
                            <Link to={config.routes.signin}> <button className={cx('btn-login')} >Đăng Nhập</button></Link>
                            }
